...
Singleton {
    ...
    readonly property string temp: Config.services.useCelsius ? `${cc?.temp_C ?? 0}°C` : `${cc?.temp_F ?? 0}°F`
    readonly property string feelsLike: Config.services.useCelsius ? `${cc?.FeelsLikeC ?? 0}°C` : `${cc?.FeelsLikeF ?? 0}°F`
